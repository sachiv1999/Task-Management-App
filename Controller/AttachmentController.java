...
public class AttachmentController {
	...
	@PostMapping("/upload")
	public ResponseEntity<com.TaskManagement.Entity.Attachment> ulpoad(@RequestParam Long issueId,@RequestParam MultipartFile file,@RequestParam String uploadedBy){
		com.TaskManagement.Entity.Attachment saved = attachmentService.upload(issueId, file, uploadedBy);
	...
	public ResponseEntity<byte[]>download(@PathVariable Long id){
		...
		String fileName= attachmentService.getdownloadByContentType(id);
